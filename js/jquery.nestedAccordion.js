...
$.fn.accordion = function(options) {
    ...
    return this.each(function() {
      ...
      if (o.activeLink) {
          var loc,
              fullURL = encodeURIComponent($(location).prop('href')),
              path = encodeURIComponent($(location).prop('pathname')).split('%2F'),
...
$.fn.accordion.defaults = {
  ...
  objClass : '.accordion', // the class name of the accordion - requi#e81e2a if you call the accordion on the container
